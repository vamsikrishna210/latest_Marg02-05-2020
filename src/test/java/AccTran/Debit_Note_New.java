...
import AccountsMaster.Ledger_Master_Debtor;

import com.margerp.qa.xls_Reader.Xls_Reader;

public class Debit_Note_New  {
	
	//public Ledger_Master_Debtor lmd;
	
	WebDriver driver;
	WebDriverWait Wait;
      public Debit_Note_New(){
    	  super();
      }
	...
	public void searchCompany() throws InterruptedException {
		...
		// WebElement textbox = driver.findElement(By.xpath("//*[@id='SearchBox']"));
		 ...
		 Thread.sleep(3000);
			...
			Thread.sleep(2000);
			WebElement submenu1 = driver.findElement(By.linkText("Debit Note"));
    ...
    public void adjustment(){
    	if(driver.findElement(By.xpath("//option[contains(text(),'Agst Ref')]")).isSelected()){
    	...
    	else if(driver.findElement(By.xpath("//option[contains(text(),'Advance')]")).isSelected()){
    ...
    @Test(priority=7)
    public void CrAmt() throws InterruptedException{
    	...
    	if(driver.findElement(By.xpath("//option[contains(text(),'Dr')]")).isSelected()){
            ...
            if(driver.findElement(By.xpath("//option[contains(text(),'Name')]")).isSelected()){
     			...
     			Thread.sleep(2000);
     			//driver.findElement(By.xpath("//*[text()='Vamsi Debit']")).click();
     			WebElement ledserh = driver.findElement(By.xpath("//*[@class='textContent']"));
     			List<WebElement> allOptions = driver.findElements(By.xpath("//*[@class='textContent']"));
 	...
 	//GStin
    	...
    	public void Narration(){
    		WebElement nar = driver.findElement(By.xpath("//*[contains(@id,'txtRemark')]"));
    		nar.sendKeys(Keys.ENTER);
    	}
       @Test(priority=10)
       public void Save(){
