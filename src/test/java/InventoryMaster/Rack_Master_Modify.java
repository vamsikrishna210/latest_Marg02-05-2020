...
public class Rack_Master_Modify {
	WebDriver driver;
	WebDriverWait Wait;
	@BeforeSuite
	 public void webLaunchM() {
	...
	@Test(priority=1)
	 public void actionM() throws InterruptedException{
	...
	public void changee(){
		...
		Select Storename = new Select(driver.findElement(By.id("storelinkid")));
		Storename.selectByVisibleText("Raja Garden");
		
		WebElement name = driver.findElement(By.xpath(" //input[@id='name']"));
		name.clear();
		name.sendKeys("mykgfstore");
	}
	@Test(priority=5)
	public void upadte(){
