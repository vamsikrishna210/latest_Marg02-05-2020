...
public class Ledger_Branch_Division {
  ...
  @Test(priority=12)
	public void balance_mtd() throws InterruptedException
	{
	  ...
	  if(driver.findElement(By.xpath("//option[contains(text(),'Bill By Bill')]")).isSelected()){
		 // WebElement dt = driver.findElement(By.xpath("//*[contains(@id,'txt-dDate-0')]"));
		  WebDriverWait wait = new WebDriverWait(driver, 20);
			...
			// WebElement Date = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@class='form-control mydate ng-valid ng-touched ng-dirty'and@id='txtbillDate']")));
			 WebElement Date = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@id,'txt-dDate-0')]")));
			...
			//Thread.sleep(5000);
			 ...
			 // Remarks
					...
					WebElement sav = driver.findElement( By.xpath("//div[@class='pageButton']//span[contains(text(),'Save')]"));
					sav.click();
		  
	  }
	  else if(driver.findElement(By.xpath("//option[contains(text(),'Fifo Base')]")).isSelected()){
		  WebDriverWait wait = new WebDriverWait(driver, 20);
			 DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy");
			 LocalDate date = LocalDate.now();
			// WebElement Date = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@class='form-control mydate ng-valid ng-touched ng-dirty'and@id='txtbillDate']")));
	  ...
	  else if(driver.findElement(By.xpath("//option[contains(text(),'On Account')]")).isSelected()){
		  WebElement sav = driver.findElement( By.xpath("//div[@class='pageButton']//span[contains(text(),'Save')]"));
			sav.click();
	  }
	}
