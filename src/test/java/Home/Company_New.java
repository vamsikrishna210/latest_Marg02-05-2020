...
public class Company_New {
	...
	public void create() throws InterruptedException{
		...
		driver.findElement(By.id("txtcompname")).sendKeys("vamsikrishna");
		driver.findElement(By.id("txtaddress1")).sendKeys("nsp ,ksajhd &asdjhlf,Delhi");
		driver.findElement(By.id("txtaddress2")).sendKeys("nsp ,ksajhd &asdjhlf,Delhi");
		driver.findElement(By.id("txtaddress3")).sendKeys("nsp ,ksajhd &asdjhlf,Delhi");
	}
	@Test(priority=2)
	...
	@Test(priority=4)
	public void Pincode() {
		driver.findElement(By.xpath("//*[@id='txtpincode']")).sendKeys("123456");
	...
	public void contactinfo() throws InterruptedException{
       ...
       phn.sendKeys("1234567890123456789");
	...
	public void uploadImage() throws AWTException, InterruptedException{
		...
		Thread.sleep(2000);
		StringSelection stringSelection = new StringSelection("C:\\Users\\Vamsikrishna\\Desktop\\123.jpg"); 
	...
	public void Regtype() throws InterruptedException{
		List<WebElement> listregt= driver.findElements(By.xpath("//*[@id='comptype']"));
	...
	public void Gst(){
		if(driver.findElement(By.xpath("//*[@id='comptype']/option[1]")).isSelected()){
			driver.findElement(By.xpath("//input[@id='gstnumber']")).sendKeys("07AADFJ5464G1ZC");
			 WebElement datgst= driver.findElement(By.xpath("//input[@id='txtregdate']"));
		        datgst.sendKeys("30042018");
		}
	...
	public void TradeLIC(){
		...
		trade.sendKeys("98787414fgsfdgsgfdsgbxvxb");
	        WebElement datst= driver.findElement(By.xpath("//input[@id='dlexpdate']"));
	        datst.sendKeys("30042020");
	        driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
	        driver.findElement(By.id("btn-Switch Tab")).click();
		}
			...
			trade1.sendKeys("98787414fgsfdgsgfdsgbxvxb");
			WebElement datst= driver.findElement(By.xpath("//input[@id='dlexpdate']"));
	        datst.sendKeys("30042020");
	        driver.findElement(By.id("btn-Switch Tab")).click();
		}
			...
			trade2.sendKeys("98787414fgsfdgsgfdsgbxvxb");
			WebElement datst= driver.findElement(By.xpath("//input[@id='dlexpdate']"));
	        datst.sendKeys("30042020");
	        driver.findElement(By.id("btn-Switch Tab")).click();
	}
...
//Date Type
	       ...
	       dt.selectByVisibleText("Bikram Samwat");
	...
	public void workingstl() throws InterruptedException{
	     ...
	     ws.selectByVisibleText("Secondary (Batch/Mrp/Size)");
	      //juridction  
	     driver.findElement(By.xpath("//input[@id='txtJurisdiction']")).sendKeys("~!~!~!VAMSIKGF~!@#$%^&*(hfhhhhh31319787");
	}
	...
	public static void main(String[] args) throws Exception {
		Company_New nm = new Company_New();
		nm.webLaunch();
		nm.login();
		nm.create();
		nm.country();
