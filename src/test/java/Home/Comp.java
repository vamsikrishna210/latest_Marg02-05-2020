...
public class Comp {
	...
	String ctry=			reader.getCellData("Sheet1", "country", 2);
	...
	String url       =		reader.getCellData("Sheet1", "website", 2);
	String e1        =		reader.getCellData("Sheet1", "email id", 2);
	String Bustype   =		reader.getCellData("Sheet1", "Bus_Type", 2);
	String Reg       =		reader.getCellData("Sheet1", "Reg_Type", 2);
	...
	String workingstyle=	reader.getCellData("Sheet1", "Work_Style", 2);
	...
	public void branchcode(){
      ...
      for(int i=0;i<countBt;i++){
        ...
        bt.selectByVisibleText(Bustype);
        }
	//}
	@Test(priority=6)
	public void fyn(){
	...
	public void contactinfo() throws InterruptedException{
       ...
       int size = typedValue.length();
		...
		if (size == 12) {
			driver.findElement(By.xpath("//input[@id='txtUrl']")).sendKeys(url);
		}
        ...
        driver.findElement(By.xpath("//input[@id='txtUrl']")).sendKeys(url);
        driver.findElement(By.xpath("//input[@id='txtuserEmailid']")).sendKeys(e1);
        driver.findElement(By.xpath("//button[@id='addButtonEmail']")).click();
        driver.findElement(By.xpath("//input[@id='extraEmail']")).sendKeys(e1);
        driver.findElement(By.xpath("//button[@id='addButtonEmail']")).click();
	}
	@Test(priority=8)
	public void uploadImage() throws AWTException, InterruptedException{
		...
		Thread.sleep(2000);
		StringSelection stringSelection = new StringSelection("C:\\Users\\Vamsikrishna\\Desktop\\download1.jpg"); 
...
//Date Type
	...
	public void workingstl() throws InterruptedException{
	     ...
	     ws.selectByVisibleText(workingstyle);
	      //juridction  
	     
	    WebElement juri =  driver.findElement(By.xpath("//input[@id='txtJurisdiction']"));
	    juri.clear();
	    juri.sendKeys(state);
	}
